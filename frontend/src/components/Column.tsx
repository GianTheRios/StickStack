      ...
      <div className="px-4 py-3 border-b-2 border-gray-900">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className={`text-base ${id === 'done' ? 'text-emerald-600 font-bold' : ''}`}>
              {config.icon}
            </span>
        ...
        {showCollapsed && hiddenCount > 0 && (
          ...
          >
            ...
            <div className="relative h-16">
              <div className="absolute inset-x-2 top-2 h-10 bg-gray-200 rounded-lg border-2 border-gray-300 opacity-60" />
              <div className="absolute inset-x-1 top-1 h-10 bg-gray-100 rounded-lg border-2 border-gray-300 opacity-80" />
              <div className="absolute inset-x-0 top-0 h-10 bg-white rounded-lg border-2 border-gray-900 shadow-3d-sm
                flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors">
                <span className="text-sm font-medium text-gray-600">+{hiddenCount} more</span>
