...
export function TaskDetailModal({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl border-2 border-gray-900 shadow-3d w-full max-w-2xl max-h-[90vh] flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full bg-white border-2 border-gray-200 rounded-lg px-3 py-2.5
                ...
                <button
                  ...
                  className={`
                    ...
                    ${priority === option.value
                      ? 'border-gray-900 shadow-3d-sm bg-gray-50'
