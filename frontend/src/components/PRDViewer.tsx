  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-6 transition-colors">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <button
          onClick={onBack}
          className="mb-6 flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
        >
        ...
        {/* Header card */}
        <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-900 dark:border-gray-600 shadow-3d p-8 mb-6">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4">{prd.title}</h1>
          <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">{prd.overview}</p>
          ...
          <div className="flex gap-6 mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{prd.phases.length}</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Phases</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center">
            ...
            {prd.techStack.length > 0 && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{prd.techStack.length}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Technologies</p>
                </div>
              </div>
            )}
          </div>
        ...
        {/* Tech Stack */}
        {prd.techStack.length > 0 && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-900 dark:border-gray-600 shadow-3d p-6 mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {prd.techStack.map((item, index) => (
                <div
                  key={index}
                  className="px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700"
                >
                  <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide block">
                    {item.category}
                  </span>
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{item.technology}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-900 dark:border-gray-600 shadow-3d p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-1">CLAUDE.md</h2>
        ...
        <div className="space-y-4 mb-8">
          {prd.phases.map((phase, phaseIndex) => (
            <div
              key={phaseIndex}
              className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-900 dark:border-gray-600 shadow-3d overflow-hidden"
            >
              {/* Phase header */}
              <div className="note-yellow px-6 py-4 border-b-2 border-gray-900 dark:border-gray-600">
                <div className="flex items-center justify-between">
                  ...
                  {phase.tasks.map((task, taskIndex) => (
                    ...
                    >
                      <div className="mt-0.5">
                        <div className="w-5 h-5 rounded border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700" />
                      </div>
      ...
      {showClaudeMd && (
        ...
        >
          <div className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-900 dark:border-gray-600 shadow-3d w-full max-w-2xl max-h-[80vh] flex flex-col">
            <div className="px-6 py-4 border-b-2 border-gray-200 dark:border-gray-700 flex items-center justify-between">
              <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100">CLAUDE.md Preview</h2>
              <div className="flex items-center gap-2">
                <button
                  onClick={handleCopyClaudeMd}
                  className="px-3 py-1.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg text-sm font-medium
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-gray-900 dark:bg-gray-100 hover:bg-gray-700 dark:hover:bg-gray-300 rounded-lg text-sm font-medium
            ...
            <div className="flex-1 overflow-auto p-6">
              <pre className="text-sm text-gray-700 dark:text-gray-300 font-mono whitespace-pre-wrap">{claudeMdContent}</pre>
            </div>
          </div>
        </div>
      )}
